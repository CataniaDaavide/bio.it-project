import { Link, Palette, Users } from "lucide-react";
...
export function Funzionalita() {
    ...
    return (
        <div className="w-full flex flex-col items-center justify-center px-3 py-20 gap-5 bg-zinc-100/90 dark:bg-zinc-800">
            <a href="/" className="text-3xl font-bold ">Come funziona bio.it</a>      
...
export function CardFunzionalita({ data }) {
    ...
    return (
        <div className="flex flex-col items-center justify-center max-w-[500px] w-full h-52 rounded-lg shadow-md p-5 gap-3 text-center border border-zinc-300 dark:border-zinc-800 bg-white dark:bg-zinc-900">
